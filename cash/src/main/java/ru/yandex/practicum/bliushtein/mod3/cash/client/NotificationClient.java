...
public class NotificationClient {
    ...
    @CircuitBreaker(name = "notificationCircuitBreaker", fallbackMethod = "logNotificationError")
    public void sendNotification(String email, String subject, String message) {
        RestClient restClient = restClientBuilder.build();
        CreateNotificationRequest request =
                new CreateNotificationRequest("cash-application", email, subject, message);
        restClient.post()
